...
6,740語を一意に分類しています。追加語の学年はゲーム内部の推定値であり、教科書準拠ではありません。
...
| 12 | 高校3年以降 | NGSL・NAWL＋追加B1〜C2語彙 | 2,991 |
...
|---|---|---:|---:|
| `5` | 英検5級相当 | CEFR A1基礎帯 | 340 |
| `4` | 英検4級相当 | CEFR A1中間帯 | 327 |
| `3` | 英検3級相当 | CEFR A1後半帯 | 198 |
| `pre2` | 英検準2級相当 | CEFR A2前半帯 | 634 |
| `pre2plus` | 英検準2級プラス相当 | CEFR A2後半帯 | 461 |
| `2` | 英検2級相当 | CEFR B1 | 1,707 |
| `pre1` | 英検準1級相当 | CEFR B2 | 2,161 |
...
5. 追加2,956語はOpen English WordNetとJapanese WordNetの同一概念・同一品詞を照合し、
   その日本語語義がEJDict本文にも存在する場合だけ採用する。
6. 3級以下へ追加した基礎18語はCEFR-J A1の語・品詞とEJDict-hand本文を人が個別確認し、
   活用形、固有名、数字、綴り違い、出題が曖昧になる語を除外して5級・4級・3級へ各6語に分ける。
