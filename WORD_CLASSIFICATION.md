...
学習指導要領が示す語数の目安と、`words.json` の NGSL・NAWL 頻度順位を使って、
3,766語を一意に分類しています。各リスト内で頻度順位が高い語ほど先に学ぶ語として扱います。

## 分類表

| `schoolGrade` | 表示 | 出典と順位 | 語数 |
|---:|---|---:|---:|
| 5 | 小学5年 | NGSL 1〜325 | 325 |
| 6 | 小学6年 | NGSL 326〜650 | 325 |
| 7 | 中学1年 | NGSL 651〜1,200 | 550 |
| 8 | 中学2年 | NGSL 1,201〜1,750 | 550 |
| 9 | 中学3年 | NGSL 1,751〜2,300 | 550 |
| 10 | 高校1年 | NGSL 2,301〜2,809 | 509 |
| 11 | 高校2年 | NAWL 1〜479 | 479 |
| 12 | 高校3年 | NAWL 480〜957 | 478 |

小学校は合計650語、中学校で新しく扱う語は合計1,650語です。
NGSLの残る509語は高校1年相当、NAWL 957語は高校2〜3年相当としています。
...
|---|---|---:|---:|
| `5` | 英検5級相当 | CEFR A1基礎帯 | 320 |
| `4` | 英検4級相当 | CEFR A1中間帯 | 297 |
| `3` | 英検3級相当 | CEFR A1後半帯 | 131 |
| `pre2` | 英検準2級相当 | CEFR A2前半帯 | 473 |
| `pre2plus` | 英検準2級プラス相当 | CEFR A2後半帯 | 278 |
| `2` | 英検2級相当 | CEFR B1 | 1,088 |
| `pre1` | 英検準1級相当 | CEFR B2 | 872 |
| `1` | 英検1級相当 | CEFR C1/C2 | 307 |
...
4. CEFR語彙表に一致しない433語は、NGSL語48語を一般頻度帯、
...
- `wordList` は `NGSL_1_2` または `NAWL_1_2` を保持する。
- `sourceRank` は各語彙リスト内の順位であり、異なるリスト間では比較しない。
- `ngslRank` はNGSL語だけが持ち、NAWL語では `null` とする。
